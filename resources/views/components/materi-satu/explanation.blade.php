    ...
    <div class="position-relative h-100 w-100">
        <div class="p-5 h-100 d-flex flex-column">
            <div>
                ...
                <div class="mt-3">
                    <div class="fw-bold">
                        Diskusi hasil dan refleksi proses
                    </div>
                    <a class="d-block ms-3 text-white mt-1" href="#" style="text-decoration: none;">
                        <i class="bi bi-file-earmark-fill"></i> LKM 4: Presentasi visual
                    </a>
                    <a class="d-block ms-3 text-white mt-1" href="#" style="text-decoration: none;">
                        <i class="bi bi-file-earmark-fill"></i> LKM 5: Refleksi & evaluasi solusi
                    </a>
                </div>
            </div>
