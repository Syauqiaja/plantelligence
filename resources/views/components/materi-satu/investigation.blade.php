        ...
        <div class="p-5 h-100 d-flex flex-column">
            ...
            <div class="mb-2 flex-grow-1 d-flex flex-column justify-content-end align-items-end">
                <div class="text-center" style="width: 128px;">
                    ...
                    <a href="#" class="btn btn-light p-2 text-teal text-center d-flex justify-content-center align-items-center flex-column mt-2" style="aspect-ratio:1; border-radius: 16px;">
                        <x-brain-svg/>
                        <div class="mt-1">
                            Plantelligence AI
                        </div>
