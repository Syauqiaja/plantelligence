<div class="bg-primary">
    <div class="position-relative bg-white h-100 pt-3 mt-2" id="cover-page">
        <div class="p-3">
            <div>
            ...
            <div class="d-flex align-items-center flex-column mt-1">
                <img src="{{ asset('images/plant education.jpg') }}" alt="" style="height: 300px; width: 350px;">
            </div>

            <div class="mt-1 mx-5 text-center">
