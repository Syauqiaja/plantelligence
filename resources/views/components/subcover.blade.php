<div class="bg-white">
    <div class="p-3 position-relative h-100">
        ...
        <div class="px-4 mt-5" style="font-size: 13px;">
            <p>
        ...
        <div class="mt-5 mx-5 text-center position-absolute fs-6" style="bottom: 16px; left: 0; right: 0;">
            <div class="mb-5">
            <div class="border mx-5 text-center">
                <div class="bg-light p-1 fw-bold">
                    Kurikulum
                </div>
                <div class="p-1">
                    Kurikulum merdeka
            ...
            <div class="border mt-2 mx-5 text-center">
                <div class="bg-light p-1 fw-bold">
                    Pendekatan
                </div>
                <div class="p-1">
            ...
            <p>
                ...
                <b>Program Studi S1 Pendidikan Biologi <br></b> 
